\documentclass[10pt,letterpaper,twoside,final]{memoir}
...
\newmdenv[rightline=false,topline=false,bottomline=false]{mathstuff}
\newmdenv{mathbox}
...
\marginpar{\vspace{-3.75in}\textbf{A margin picture:} \begin{center}\includegraphics[width=1.5in]{BooksPic2}\end{center} \emph{\lipsum[2]}}
